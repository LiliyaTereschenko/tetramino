...
SRC = ft_atoi.c ft_bzero.c ft_isalnum.c ft_isalpha.c ft_isascii.c ft_isdigit.c\
		ft_isprint.c ft_itoa.c ft_lstadd.c ft_lstdel.c ft_lstdelone.c ft_lstiter.c\
	   	ft_lstmap.c ft_lstnew.c ft_match.c ft_memalloc.c ft_memccpy.c ft_memchr.c\
	   	ft_memcmp.c ft_memcpy.c ft_memdel.c ft_memmove.c ft_memset.c ft_power.c\
	   	ft_putchar.c ft_putchar_fd.c ft_putendl.c ft_putendl_fd.c ft_putnbr.c\
	   	ft_putnbr_fd.c ft_putstr.c ft_putstr_fd.c ft_sort_integer_tab.c ft_sqrt.c\
...
OFILES = ft_atoi.o ft_bzero.o ft_isalnum.o ft_isalpha.o ft_isascii.o ft_isdigit.o\
			ft_isprint.o ft_itoa.o ft_lstadd.o ft_lstdel.o ft_lstdelone.o ft_lstiter.o\
		   	ft_lstmap.o ft_lstnew.o ft_match.o ft_memalloc.o ft_memccpy.o ft_memchr.o\
		   	...
		   	ft_putnbr_fd.o ft_putstr.o ft_putstr_fd.o ft_sort_integer_tab.o ft_sqrt.o\
